...
int main() {
    ...
    if (level >= 90)
        image_path = "/home/yoku/.config/waybar/icons/bateria_100.png";
    else if (level >= 70)
        image_path = "/home/yoku/.config/waybar/icons/bateria_80.png";
    else if (level >= 50)
        image_path = "/home/yoku/.config/waybar/icons/bateria_60.png";
    else if (level >= 30)
        image_path = "/home/yoku/.config/waybar/icons/bateria_40.png";
    else if (level >= 10)
        image_path = "/home/yoku/.config/waybar/icons/bateria_20.png";
    else
        image_path = "/home/yoku/.config/waybar/icons/bateria_0.png";
